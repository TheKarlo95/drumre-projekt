...
import hr.fer.drumre.rec.features.shows.recommendations.adapter.ItemView
import hr.fer.drumre.rec.features.shows.recommendations.adapter.ShowAdapterState
import hr.fer.drumre.rec.features.shows.recommendations.adapter.holders.ErrorViewHolder
import hr.fer.drumre.rec.features.shows.recommendations.adapter.holders.LoadingViewHolder
import hr.fer.drumre.rec.features.shows.recommendations.adapter.holders.ShowViewHolder
import javax.inject.Inject

class RecommendationAdapter @Inject constructor(
    private val viewModel: ShowRecommendationViewModel
